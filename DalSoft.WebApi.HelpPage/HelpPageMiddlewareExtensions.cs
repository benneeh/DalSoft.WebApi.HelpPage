...
namespace DalSoft.WebApi.HelpPage
{
    ...
    {
        public static void UseWebApiHelpPage(this IAppBuilder app, HttpConfiguration httpConfiguration, string helpRoute = null,
            string viewsPhysicalPath = null, string viewsRelativePath = null, string xmlDocumentationPhysicalPath = null, dynamic viewBag = null)
        {
            ...
            viewsPhysicalPath = viewsPhysicalPath ?? Path.Combine(executingAssemblyPath.Replace("file:\\", string.Empty), (viewsRelativePath ?? "Help\\DalSoft.WebApi.HelpPage.Views"));
            xmlDocumentationPhysicalPath = xmlDocumentationPhysicalPath ?? Path.Combine(executingAssemblyPath, executingAssemblyName + ".xml");
